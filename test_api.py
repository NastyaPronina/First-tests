...
def test_get_all_bookings():
    ...
    headers = ('Connection', 'keep-alive') # tuple
    assert headers in response.headers.items() # check if tuple exists in dictionary

    key = 'Connection'
    assert key in response.headers # check if the key exists in dictionary
